...
pub(super) const BORROW_REPAY: &str = "/api/v5/account/borrow-repay";
pub(super) const BORROW_REPAY_HISTORY: &str = "/api/v5/account/borrow-repay-history";
...
pub(super) const SET_RISK_OFFSET_TYPE: &str = "/api/v5/account/set-riskOffset-type";
