...
pub(crate) const BILLS_HISTORY: &str = "/api/v5/asset/bills-history";
...
pub(crate) const EXCHANGE_LIST: &str = "/api/v5/asset/exchange-list";
pub(crate) const MONTHLY_STATEMENT: &str = "/api/v5/asset/monthly-statement";
