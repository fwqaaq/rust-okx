...
pub(super) const BOOKS_FULL: &str = "/api/v5/market/books-full";
pub(super) const BOOKS_SBE: &str = "/api/v5/market/books-sbe";
...
pub(super) const CALL_AUCTION_DETAILS: &str = "/api/v5/market/call-auction-details";
